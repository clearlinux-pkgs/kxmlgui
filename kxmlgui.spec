...
Version  : 5.113.0
Release  : 92
URL      : https://download.kde.org/stable/frameworks/5.113/kxmlgui-5.113.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.113/kxmlgui-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kxmlgui-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kxmlgui-5.113.0
cd %{_builddir}/kxmlgui-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702997915
mkdir -p clr-build
pushd clr-build
