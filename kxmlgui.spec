...
Source0  : https://download.kde.org/stable/frameworks/6.12/kxmlgui-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/kxmlgui-6.12.0.tar.xz.sig
...
%setup -q -n kxmlgui-6.12.0
cd %{_builddir}/kxmlgui-6.12.0
pushd ..
cp -a kxmlgui-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742512793
mkdir -p clr-build
pushd clr-build
