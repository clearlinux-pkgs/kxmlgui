...
Source0  : https://download.kde.org/stable/frameworks/5.102/kxmlgui-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/kxmlgui-5.102.0.tar.xz.sig
...
%prep
%setup -q -n kxmlgui-5.102.0
cd %{_builddir}/kxmlgui-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673904927
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5XmlGui.so.5.102.0
