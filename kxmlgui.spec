...
Source0  : https://download.kde.org/stable/frameworks/5.109/kxmlgui-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/kxmlgui-5.109.0.tar.xz.sig
...
%prep
%setup -q -n kxmlgui-5.109.0
cd %{_builddir}/kxmlgui-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693075694
mkdir -p clr-build
pushd clr-build
