...
%prep
%setup -q -n kxmlgui-5.70.0
cd %{_builddir}/kxmlgui-5.70.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589225072
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kxmlgui-5.70.0/COPYING %{buildroot}/usr/share/package-licenses/kxmlgui/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/kxmlgui-5.70.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/kxmlgui/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
%find_lang kxmlgui5
...
/usr/lib64/libKF5XmlGui.so.5.70.0
