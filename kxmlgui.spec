...
Version  : 5.112.0
Release  : 91
URL      : https://download.kde.org/stable/frameworks/5.112/kxmlgui-5.112.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.112/kxmlgui-5.112.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.112/kxmlgui-5.112.0.tar.xz.sig
...
%prep
%setup -q -n kxmlgui-5.112.0
cd %{_builddir}/kxmlgui-5.112.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702011933
mkdir -p clr-build
pushd clr-build
