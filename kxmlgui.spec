...
Source0  : https://download.kde.org/stable/frameworks/5.105/kxmlgui-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/kxmlgui-5.105.0.tar.xz.sig
...
%prep
%setup -q -n kxmlgui-5.105.0
cd %{_builddir}/kxmlgui-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681746779
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5XmlGui.so.5.105.0
