...
Version  : 6.11.0
Release  : 111
URL      : https://download.kde.org/stable/frameworks/6.11/kxmlgui-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/kxmlgui-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kxmlgui-6.11.0.tar.xz.sig
...
%setup -q -n kxmlgui-6.11.0
cd %{_builddir}/kxmlgui-6.11.0
pushd ..
cp -a kxmlgui-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739576969
mkdir -p clr-build
pushd clr-build
