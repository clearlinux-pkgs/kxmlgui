...
Version  : 6.1.0
Release  : 98
URL      : https://download.kde.org/stable/frameworks/6.1/kxmlgui-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kxmlgui-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kxmlgui-6.1.0.tar.xz.sig
...
%setup -q -n kxmlgui-6.1.0
cd %{_builddir}/kxmlgui-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712968183
mkdir -p clr-build
pushd clr-build
