...
Source0  : https://download.kde.org/stable/frameworks/6.3/kxmlgui-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kxmlgui-6.3.0.tar.xz.sig
...
%setup -q -n kxmlgui-6.3.0
cd %{_builddir}/kxmlgui-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717787801
mkdir -p clr-build
pushd clr-build
